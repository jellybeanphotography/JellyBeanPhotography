...
<body>
  ...
  <style>.fullscreenimage{background-image: url(/public/images/fullscreenimage/wedding.jpg);}</style>
      ...
      <section>
          ...
          <div id="imageblock">
            <img src="public/images/wedding/weddingimage1.jpg" alt="Ceremony Image" title="Ceremony Image">
            <img src="public/images/wedding/weddingimage2.jpg" alt="Cake Image" title="Cake Image">
            <img src="public/images/wedding/weddingimage3.jpg" alt="Rings Shot" title="Rings Shot">
          </div>
        ...
        <div class="centerdivs">
          <div>
            ...
            <ul>
              <li><p>All edited images on USB Memory Stick (no limits on number of images).</p></li>
              <li><p>A unique online gallery personalised to you, you and guests can view and download the full resolution images at not extra cost (included in package).</p></li>
